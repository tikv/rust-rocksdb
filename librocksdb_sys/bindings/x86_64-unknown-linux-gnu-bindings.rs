...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct crocksdb_hyper_clock_cache_options_t {
    _unused: [u8; 0],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct crocksdb_checkpoint_t {
    _unused: [u8; 0],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct crocksdb_write_buffer_manager_t {
    _unused: [u8; 0],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct crocksdb_concurrent_task_limiter_t {
    _unused: [u8; 0],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct crocksdb_post_write_callback_t {
    _unused: [u8; 0],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct crocksdb_memtableinfo_t {
    _unused: [u8; 0],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub const crocksdb_table_u64_property_t_kDataSize: crocksdb_table_u64_property_t = 1;
pub const crocksdb_table_u64_property_t_kIndexSize: crocksdb_table_u64_property_t = 2;
pub const crocksdb_table_u64_property_t_kFilterSize: crocksdb_table_u64_property_t = 3;
pub const crocksdb_table_u64_property_t_kRawKeySize: crocksdb_table_u64_property_t = 4;
pub const crocksdb_table_u64_property_t_kRawValueSize: crocksdb_table_u64_property_t = 5;
pub const crocksdb_table_u64_property_t_kNumDataBlocks: crocksdb_table_u64_property_t = 6;
pub const crocksdb_table_u64_property_t_kNumEntries: crocksdb_table_u64_property_t = 7;
pub const crocksdb_table_u64_property_t_kFormatVersion: crocksdb_table_u64_property_t = 8;
pub const crocksdb_table_u64_property_t_kFixedKeyLen: crocksdb_table_u64_property_t = 9;
pub const crocksdb_table_u64_property_t_kColumnFamilyId: crocksdb_table_u64_property_t = 10;
pub const crocksdb_table_u64_property_t_kOriginalFileNumber: crocksdb_table_u64_property_t = 11;
pub const crocksdb_table_u64_property_t_kIndexPartitions: crocksdb_table_u64_property_t = 12;
pub const crocksdb_table_u64_property_t_kTopLevelIndexSize: crocksdb_table_u64_property_t = 13;
pub const crocksdb_table_u64_property_t_kIndexKeyIsUserKey: crocksdb_table_u64_property_t = 14;
pub const crocksdb_table_u64_property_t_kIndexValueIsDeltaEncoded: crocksdb_table_u64_property_t =
    15;
pub const crocksdb_table_u64_property_t_kNumFilterEntries: crocksdb_table_u64_property_t = 16;
pub const crocksdb_table_u64_property_t_kNumDeletions: crocksdb_table_u64_property_t = 17;
pub const crocksdb_table_u64_property_t_kNumMergeOperands: crocksdb_table_u64_property_t = 18;
pub const crocksdb_table_u64_property_t_kNumRangeDeletions: crocksdb_table_u64_property_t = 19;
pub const crocksdb_table_u64_property_t_kCreationTime: crocksdb_table_u64_property_t = 20;
pub const crocksdb_table_u64_property_t_kOldestKeyTime: crocksdb_table_u64_property_t = 21;
pub const crocksdb_table_u64_property_t_kFileCreationTime: crocksdb_table_u64_property_t = 22;
pub const crocksdb_table_u64_property_t_kSlowCompressionEstimatedDataSize:
    crocksdb_table_u64_property_t = 23;
pub const crocksdb_table_u64_property_t_kFastCompressionEstimatedDataSize:
    crocksdb_table_u64_property_t = 24;
pub type crocksdb_table_u64_property_t = libc::c_uint;
pub const crocksdb_table_str_property_t_kDbId: crocksdb_table_str_property_t = 1;
pub const crocksdb_table_str_property_t_kDbSessionId: crocksdb_table_str_property_t = 2;
pub const crocksdb_table_str_property_t_kDbHostId: crocksdb_table_str_property_t = 3;
pub const crocksdb_table_str_property_t_kFilterPolicyName: crocksdb_table_str_property_t = 4;
pub const crocksdb_table_str_property_t_kColumnFamilyName: crocksdb_table_str_property_t = 5;
pub const crocksdb_table_str_property_t_kComparatorName: crocksdb_table_str_property_t = 6;
pub const crocksdb_table_str_property_t_kMergeOperatorName: crocksdb_table_str_property_t = 7;
pub const crocksdb_table_str_property_t_kPrefixExtractorName: crocksdb_table_str_property_t = 8;
pub const crocksdb_table_str_property_t_kPropertyCollectorsNames: crocksdb_table_str_property_t = 9;
pub const crocksdb_table_str_property_t_kCompressionName: crocksdb_table_str_property_t = 10;
pub const crocksdb_table_str_property_t_kCompressionOptions: crocksdb_table_str_property_t = 11;
pub type crocksdb_table_str_property_t = libc::c_uint;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
extern "C" {
    pub fn crocksdb_merge_disjoint_instances(
        db: *mut crocksdb_t,
        merge_memtable: libc::c_uchar,
        allow_source_write: libc::c_uchar,
        max_preload_files: libc::c_int,
        instances: *mut *mut crocksdb_t,
        num_instances: usize,
        errptr: *mut *mut libc::c_char,
    );
}
...
extern "C" {
    pub fn crocksdb_checkpoint_object_create(
        db: *mut crocksdb_t,
        errptr: *mut *mut libc::c_char,
    ) -> *mut crocksdb_checkpoint_t;
}
extern "C" {
    pub fn crocksdb_checkpoint_create(
        checkpoint: *mut crocksdb_checkpoint_t,
...
extern "C" {
    pub fn crocksdb_checkpoint_object_destroy(checkpoint: *mut crocksdb_checkpoint_t);
}
extern "C" {
...
extern "C" {
    pub fn crocksdb_set_global_manual_compaction_canceled(arg1: libc::c_uchar);
}
extern "C" {
    pub fn crocksdb_disable_manual_compaction(db: *mut crocksdb_t);
}
extern "C" {
    pub fn crocksdb_enable_manual_compaction(db: *mut crocksdb_t);
}
extern "C" {
    pub fn crocksdb_put(
        db: *mut crocksdb_t,
...
extern "C" {
    pub fn crocksdb_write_callback(
        ...
        options: *const crocksdb_writeoptions_t,
        batch: *mut crocksdb_writebatch_t,
        callback: *mut crocksdb_post_write_callback_t,
        errptr: *mut *mut libc::c_char,
    );
}
extern "C" {
...
extern "C" {
    pub fn crocksdb_writebatch_iterator_value_type(it: *mut crocksdb_writebatch_iterator_t) -> u32;
}
extern "C" {
...
pub const crocksdb_block_based_table_prepopulate_block_cache_disabled: _bindgen_ty_1 = 0;
pub const crocksdb_block_based_table_prepopulate_block_cache_flush_only: _bindgen_ty_1 = 1;
...
pub const crocksdb_block_based_table_checksum_type_no_checksum: _bindgen_ty_2 = 0;
pub const crocksdb_block_based_table_checksum_type_crc32c: _bindgen_ty_2 = 1;
pub const crocksdb_block_based_table_checksum_type_xxhash: _bindgen_ty_2 = 2;
pub const crocksdb_block_based_table_checksum_type_xxhash64: _bindgen_ty_2 = 3;
pub const crocksdb_block_based_table_checksum_type_xxh3: _bindgen_ty_2 = 4;
...
extern "C" {
    pub fn crocksdb_flushjobinfo_largest_seqno(arg1: *const crocksdb_flushjobinfo_t) -> u64;
}
extern "C" {
    pub fn crocksdb_flushjobinfo_smallest_seqno(arg1: *const crocksdb_flushjobinfo_t) -> u64;
}
extern "C" {
...
extern "C" {
    pub fn crocksdb_memtableinfo_cf_name(
        arg1: *const crocksdb_memtableinfo_t,
        arg2: *mut usize,
    ) -> *const libc::c_char;
}
extern "C" {
    pub fn crocksdb_memtableinfo_first_seqno(arg1: *const crocksdb_memtableinfo_t) -> u64;
}
extern "C" {
    pub fn crocksdb_memtableinfo_earliest_seqno(arg1: *const crocksdb_memtableinfo_t) -> u64;
}
extern "C" {
    pub fn crocksdb_memtableinfo_largest_seqno(arg1: *const crocksdb_memtableinfo_t) -> u64;
}
extern "C" {
    pub fn crocksdb_memtableinfo_num_entries(arg1: *const crocksdb_memtableinfo_t) -> u64;
}
extern "C" {
    pub fn crocksdb_memtableinfo_num_deletes(arg1: *const crocksdb_memtableinfo_t) -> u64;
}
...
pub type on_background_error_cb = ::std::option::Option<
    unsafe extern "C" fn(arg1: *mut libc::c_void, arg2: u32, arg3: *mut crocksdb_status_ptr_t),
>;
...
pub type on_memtable_sealed_cb = ::std::option::Option<
    unsafe extern "C" fn(arg1: *mut libc::c_void, arg2: *const crocksdb_memtableinfo_t),
>;
extern "C" {
...
pub type on_post_write_callback_cb =
    ::std::option::Option<unsafe extern "C" fn(arg1: *mut libc::c_void, arg2: u64)>;
extern "C" {
    pub fn crocksdb_post_write_callback_init(
        buf: *mut libc::c_void,
        buf_len: usize,
        state_: *mut libc::c_void,
        on_post_write_callback: on_post_write_callback_cb,
    ) -> *mut crocksdb_post_write_callback_t;
}
extern "C" {
...
extern "C" {
    pub fn crocksdb_set_bottommost_compression(opt: *mut crocksdb_options_t, c: u32);
}
extern "C" {
...
extern "C" {
    pub fn crocksdb_options_set_write_buffer_manager(
        arg1: *mut crocksdb_options_t,
        arg2: *mut crocksdb_write_buffer_manager_t,
    );
}
extern "C" {
...
extern "C" {
    pub fn crocksdb_options_set_compaction_thread_limiter(
        arg1: *mut crocksdb_options_t,
        arg2: *mut crocksdb_concurrent_task_limiter_t,
    );
}
extern "C" {
    pub fn crocksdb_options_get_compaction_thread_limiter(
        arg1: *mut crocksdb_options_t,
    ) -> *mut crocksdb_concurrent_task_limiter_t;
}
extern "C" {
...
extern "C" {
    pub fn crocksdb_options_set_info_log_level(arg1: *mut crocksdb_options_t, arg2: u32);
}
extern "C" {
...
extern "C" {
    pub fn crocksdb_options_set_statistics(
        opt: *mut crocksdb_options_t,
        statistics: *mut crocksdb_statistics_t,
    );
}
extern "C" {
    pub fn crocksdb_options_get_statistics(
        opt: *mut crocksdb_options_t,
    ) -> *mut crocksdb_statistics_t;
}
extern "C" {
...
extern "C" {
    pub fn crocksdb_titan_statistics_create() -> *mut crocksdb_statistics_t;
}
extern "C" {
    pub fn crocksdb_empty_statistics_create() -> *mut crocksdb_statistics_t;
}
extern "C" {
    pub fn crocksdb_statistics_destroy(statistics: *mut crocksdb_statistics_t);
}
extern "C" {
    pub fn crocksdb_statistics_is_empty(statistics: *mut crocksdb_statistics_t) -> libc::c_uchar;
}
extern "C" {
    pub fn crocksdb_statistics_to_string(
        statistics: *mut crocksdb_statistics_t,
    ) -> *mut libc::c_char;
}
extern "C" {
...
extern "C" {
    pub fn crocksdb_options_set_stats_persist_period_sec(arg1: *mut crocksdb_options_t, arg2: u32);
}
extern "C" {
...
extern "C" {
    pub fn crocksdb_options_set_wal_recovery_mode(arg1: *mut crocksdb_options_t, arg2: u32);
}
...
extern "C" {
    pub fn crocksdb_options_get_compression(arg1: *mut crocksdb_options_t) -> u32;
}
extern "C" {
    pub fn crocksdb_options_set_compaction_style(arg1: *mut crocksdb_options_t, arg2: u32);
}
extern "C" {
...
extern "C" {
    pub fn crocksdb_options_get_write_buffer_manager(
        opt: *mut crocksdb_options_t,
    ) -> *mut crocksdb_write_buffer_manager_t;
}
extern "C" {
...
extern "C" {
    pub fn crocksdb_options_avoid_flush_during_recovery(
        opt: *mut crocksdb_options_t,
        avoid: libc::c_uchar,
    );
}
extern "C" {
    pub fn crocksdb_options_avoid_flush_during_shutdown(
        opt: *mut crocksdb_options_t,
        avoid: libc::c_uchar,
    );
}
extern "C" {
    pub fn crocksdb_options_set_track_and_verify_wals_in_manifest(
        opt: *mut crocksdb_options_t,
        track_wals_in_manifest: libc::c_uchar,
    );
}
extern "C" {
    pub fn crocksdb_write_buffer_manager_create(
        flush_size: usize,
        stall_ratio: f32,
        flush_oldest_first: libc::c_uchar,
    ) -> *mut crocksdb_write_buffer_manager_t;
}
extern "C" {
    pub fn crocksdb_write_buffer_manager_set_flush_size(
        wbm: *mut crocksdb_write_buffer_manager_t,
        flush_size: usize,
    );
}
extern "C" {
    pub fn crocksdb_write_buffer_manager_flush_size(
        wbm: *mut crocksdb_write_buffer_manager_t,
    ) -> usize;
}
extern "C" {
...
extern "C" {
    pub fn crocksdb_write_buffer_manager_memory_usage(
        wbm: *mut crocksdb_write_buffer_manager_t,
    ) -> usize;
}
extern "C" {
    pub fn crocksdb_write_buffer_manager_destroy(wbm: *mut crocksdb_write_buffer_manager_t);
}
extern "C" {
...
extern "C" {
    pub fn crocksdb_concurrent_task_limiter_set_limit(
        limiter: *mut crocksdb_concurrent_task_limiter_t,
        limit: u32,
    );
}
extern "C" {
    pub fn crocksdb_concurrent_task_limiter_destroy(
        limiter: *mut crocksdb_concurrent_task_limiter_t,
    );
}
...
extern "C" {
    pub fn crocksdb_options_set_compaction_priority(arg1: *mut crocksdb_options_t, arg2: u32);
}
extern "C" {
...
extern "C" {
    pub fn crocksdb_options_set_ttl(opt: *mut crocksdb_options_t, ttl: u64);
}
extern "C" {
    pub fn crocksdb_options_get_ttl(opt: *const crocksdb_options_t) -> u64;
}
extern "C" {
...
extern "C" {
    pub fn crocksdb_options_get_periodic_compaction_seconds(opt: *const crocksdb_options_t) -> u64;
}
extern "C" {
    pub fn crocksdb_options_set_bottommost_file_compaction_delay(
        opt: *mut crocksdb_options_t,
        delay: u32,
    );
}
extern "C" {
    pub fn crocksdb_options_get_bottommost_file_compaction_delay(
        opt: *const crocksdb_options_t,
    ) -> u32;
}
extern "C" {
    ...
    pub fn crocksdb_compactionfilter_create(
        ...
        filter: ::std::option::Option<
            unsafe extern "C" fn(
                ...
                skip_until: *mut *mut libc::c_char,
                skip_until_length: *mut usize,
            ) -> u32,
        >,
...
extern "C" {
    pub fn crocksdb_compactionfilter_destroy(filter: *mut crocksdb_compactionfilter_t);
}
extern "C" {
...
extern "C" {
    pub fn crocksdb_compactionfilterfactory_create(
        ...
        should_filter_table_file_creation: ::std::option::Option<
            unsafe extern "C" fn(arg1: *mut libc::c_void, reason: u32) -> libc::c_uchar,
        >,
        name: ::std::option::Option<
            unsafe extern "C" fn(arg1: *mut libc::c_void) -> *const libc::c_char,
        >,
...
extern "C" {
    pub fn crocksdb_flushoptions_set_expected_oldest_key_time(
        arg1: *mut crocksdb_flushoptions_t,
        arg2: u64,
    );
}
...
extern "C" {
    ...
    ) -> *mut crocksdb_hyper_clock_cache_options_t;
}
extern "C" {
    pub fn crocksdb_hyper_clock_cache_options_make_shared_cache(
        arg1: *mut crocksdb_hyper_clock_cache_options_t,
    ) -> *mut crocksdb_cache_t;
}
extern "C" {
...
extern "C" {
    pub fn crocksdb_ingestexternalfileoptions_set_verify_checksums_before_ingest(
        opt: *mut crocksdb_ingestexternalfileoptions_t,
        verify_checksums_before_ingest: libc::c_uchar,
    );
}
extern "C" {
    pub fn crocksdb_ingestexternalfileoptions_set_allow_write(
        opt: *mut crocksdb_ingestexternalfileoptions_t,
        allow_write: libc::c_uchar,
    );
}
extern "C" {
...
extern "C" {
    pub fn crocksdb_get_supported_compression(arg1: *mut u32, arg2: usize);
}
extern "C" {
    pub fn crocksdb_table_properties_get_u64(
        arg1: *const crocksdb_table_properties_t,
        prop: crocksdb_table_u64_property_t,
    ) -> u64;
}
extern "C" {
    pub fn crocksdb_table_properties_get_str(
        arg1: *const crocksdb_table_properties_t,
        prop: crocksdb_table_str_property_t,
        slen: *mut usize,
    ) -> *const libc::c_char;
}
extern "C" {
...
extern "C" {
    pub fn crocksdb_sst_partitioner_context_push_bounary_and_size(
        context: *mut crocksdb_sst_partitioner_context_t,
        boundary_key: *const libc::c_char,
        boundary_key_len: usize,
        size: usize,
    );
}
extern "C" {
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ctitandb_checkpoint_t {
    _unused: [u8; 0],
}
extern "C" {
...
extern "C" {
    pub fn ctitandb_checkpoint_object_create(
        db: *mut crocksdb_t,
        errptr: *mut *mut libc::c_char,
    ) -> *mut ctitandb_checkpoint_t;
}
extern "C" {
    pub fn ctitandb_checkpoint_create(
        checkpoint: *mut ctitandb_checkpoint_t,
        basedb_checkpoint_dir: *const libc::c_char,
        titan_checkpoint_dir: *const libc::c_char,
        log_size_for_flush: u64,
        errptr: *mut *mut libc::c_char,
    );
}
extern "C" {
    pub fn ctitandb_checkpoint_object_destroy(checkpoint: *mut ctitandb_checkpoint_t);
}
extern "C" {
...
extern "C" {
    pub fn ctitandb_options_set_blob_run_mode(options: *mut ctitandb_options_t, mode: u32);
}
extern "C" {
