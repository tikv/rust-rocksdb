...
void crocksdb_persistent_cache_set_env(crocksdb_persistent_cache_options_t* opt,
                                       crocksdb_env_t* env) {
  opt->rep.env = env->rep;
}

void crocksdb_persistent_cache_set_path(
    crocksdb_persistent_cache_options_t* opt, const char* path) {
  opt->rep.path = path;
}

void crocksdb_persistent_cache_set_log(crocksdb_persistent_cache_options_t* opt,
                                       crocksdb_logger_t* log) {
  opt->rep.log = log->rep;
}
