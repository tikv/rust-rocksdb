...
extern C_ROCKSDB_LIBRARY_API uint64_t crocksdb_sst_file_meta_data_num_entries(
    const crocksdb_sst_file_meta_data_t*);
extern C_ROCKSDB_LIBRARY_API uint64_t crocksdb_sst_file_meta_data_num_deletions(
    const crocksdb_sst_file_meta_data_t*);
