...
extern C_ROCKSDB_LIBRARY_API void crocksdb_options_set_env(crocksdb_options_t*,
                                                           crocksdb_env_t*);
extern C_ROCKSDB_LIBRARY_API void crocksdb_options_add_write_buffer_manager(
    crocksdb_options_t*, crocksdb_write_buffer_manager_t*,  const char**, int);
extern C_ROCKSDB_LIBRARY_API void
...
extern C_ROCKSDB_LIBRARY_API void crocksdb_options_get_write_buffer_manager(
    crocksdb_options_t* opt, crocksdb_write_buffer_manager_t*** managers,
    size_t* manager_len);
